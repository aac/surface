...
Items marked [ASK] represent possible future decisions for Andrew.
...
call that belongs in `docs/decisions.md` and may need Andrew's input on how much
friction is acceptable vs. how much specificity helps Claude Code users.
